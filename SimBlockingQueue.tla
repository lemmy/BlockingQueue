...
View ==
    \* We exploit the insight that the order of elements in the (fifo) buffer
    \* is irrelevant for the correctness of the algorithm.  In other words,
    \* we can abstract the buffer into a simple counter of elements.
